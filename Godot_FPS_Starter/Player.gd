...
var grenade_amounts = {"Grenade":10,"Sticky Grenade":10}
var current_grenade = "Grenade"
var grenade_scene = preload("res://Grenade.tscn")
var sticky_grenade_scene = preload("res://Sticky_Grenade.tscn")
const GRENADE_THROW_FORCE = 90
...
func process_input(delta):	
	if Input.is_action_just_pressed("mouse_enable"):
		Input.set_mouse_mode(Input.MOUSE_MODE_CAPTURED)
...
func add_grenade(additional_grenade):
	...
	grenade_amounts[current_grenade] = clamp(grenade_amounts[current_grenade], 0, 30)
...
func process_respawn(delta):
	...
	if is_dead:
		...
		if dead_time <= 0:
			...
			health = 300
			grenade_amounts = {"Grenade":10, "Sticky Grenade":10}
			current_grenade = "Grenade"
